...
6. **3D Rounded App Icon & Clean Desktop Experience**:
   ...
   - Double-clickable `run.bat` launcher that opens cleanly without background console windows.
...
Simply double-click [`run.bat`](run.bat) in this folder. It launches the application cleanly with `pythonw`.

### Method 2: Create a Desktop Shortcut
Double-click [`create_desktop_shortcut.bat`](create_desktop_shortcut.bat) to place a `DocGini` shortcut directly on your Windows Desktop equipped with the 3D rounded icon.
